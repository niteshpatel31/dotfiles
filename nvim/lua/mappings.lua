...
-- Telescope
keymap.set("n", "<Space>tf", "<cmd>Telescope find_files<cr>",          { desc = "find files" })
keymap.set("n", "<Space>tg", "<cmd>Telescope live_grep<cr>",           { desc = "live grep" })
keymap.set("n", "<Space>tb", "<cmd>Telescope buffers<cr>",             { desc = "find buffers" })
keymap.set("n", "<Space>th", "<cmd>Telescope help_tags<cr>",           { desc = "help tags" })
keymap.set("n", "<Space>tr", "<cmd>Telescope oldfiles<cr>",            { desc = "recent files" })
keymap.set("n", "<Space>tc", "<cmd>Telescope commands<cr>",            { desc = "commands" })
keymap.set("n", "<Space>tk", "<cmd>Telescope keymaps<cr>",             { desc = "keymaps" })
keymap.set("n", "<Space>ts", "<cmd>Telescope lsp_document_symbols<cr>",{ desc = "document symbols" })
keymap.set("n", "<Space>td", "<cmd>Telescope diagnostics<cr>",         { desc = "diagnostics" })
keymap.set("n", "<Space>tq", "<cmd>Telescope quickfix<cr>",            { desc = "quickfix" })
